...
namespace Psd.H5Show.BLL
{
	...
	{
		private readonly Psd.H5Show.DAL.apppagebase dal=new Psd.H5Show.DAL.apppagebase();
		public apppagebase()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Psd.H5Show.Model.apppagebase GetModelByCache(Int32 ID)
		{
			
			string CacheKey = "apppagebaseModel-" + ID;
			...
			return (Psd.H5Show.Model.apppagebase)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Psd.H5Show.Model.apppagebase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Psd.H5Show.Model.apppagebase> DataTableToList(DataTable dt)
		{
			List<Psd.H5Show.Model.apppagebase> modelList = new List<Psd.H5Show.Model.apppagebase>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Psd.H5Show.Model.apppagebase model;
