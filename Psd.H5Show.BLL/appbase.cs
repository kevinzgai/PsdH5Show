...
namespace Psd.H5Show.BLL
{
	...
	{
		private readonly Psd.H5Show.DAL.appbase dal=new Psd.H5Show.DAL.appbase();
		public appbase()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Psd.H5Show.Model.appbase GetModelByCache(Int32 ID)
		{
			
			string CacheKey = "appbaseModel-" + ID;
			...
			return (Psd.H5Show.Model.appbase)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Psd.H5Show.Model.appbase> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Psd.H5Show.Model.appbase> DataTableToList(DataTable dt)
		{
			List<Psd.H5Show.Model.appbase> modelList = new List<Psd.H5Show.Model.appbase>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Psd.H5Show.Model.appbase model;
