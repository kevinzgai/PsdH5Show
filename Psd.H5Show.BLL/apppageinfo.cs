...
namespace Psd.H5Show.BLL
{
	...
	{
		private readonly Psd.H5Show.DAL.apppageinfo dal=new Psd.H5Show.DAL.apppageinfo();
		public apppageinfo()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Psd.H5Show.Model.apppageinfo GetModelByCache(Int32 ID)
		{
			
			string CacheKey = "apppageinfoModel-" + ID;
			...
			return (Psd.H5Show.Model.apppageinfo)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Psd.H5Show.Model.apppageinfo> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Psd.H5Show.Model.apppageinfo> DataTableToList(DataTable dt)
		{
			List<Psd.H5Show.Model.apppageinfo> modelList = new List<Psd.H5Show.Model.apppageinfo>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Psd.H5Show.Model.apppageinfo model;
